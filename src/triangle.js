export default function Triangle(side1, side2, side3) {
  ...
  this.side2 = side2;
  this.side3 = side3;
  // this.isTriangle = ((this.side1 > (this.side2 + this.side3)) || (this.side2 > (this.side1 + this.side3)) || (this.side3 > (this.side1 + this.side))) ? "not a triangle" : "this is a triangle";
